...
class TiketResourceIT {
    ...
    private static final Integer DEFAULT_TREN_ID = 1;
    private static final Integer UPDATED_TREN_ID = 2;
    ...
    void getAllTikets() throws Exception {
        ...
        restTiketMockMvc
            ...
            .andExpect(jsonPath("$.[*].trenId").value(hasItem(DEFAULT_TREN_ID)))
    ...
    void getTiket() throws Exception {
        ...
        restTiketMockMvc
            ...
            .andExpect(jsonPath("$.trenId").value(DEFAULT_TREN_ID))
